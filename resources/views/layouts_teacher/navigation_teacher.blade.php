...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard-teacher')" :active="request()->routeIs('dashboard-teacher')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('course-list-teacher')" :active="request()->routeIs('course-list-teacher', 'student-list')">
                        {{ __('Courses List') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('calendarIndex')" :active="request()->routeIs('calendarIndex', 'schedule-teacher')">
                        {{ __('Calandar') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('calendarIndex')" :active="request()->routeIs('schedule-teacher')">
                {{ __('Calendar') }}
            </x-responsive-nav-link>
        </div>
