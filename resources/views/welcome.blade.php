    ...
    <main>
        ...
        <section class="pb-20 bg-gray-300 -mt-24">
            <div class="container mx-auto px-4">
                        ...
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <p class="mt-2 mb-4 text-gray-600">
                                    Ở DBEC luôn đề cao 5 giá trị gồm: Trách nhiệm & đam mê, Toàn diện, Nhân văn, Tiên
                                    phong, Vì cộng đồng...
                                </p>
                    ...
                    <div class="w-full md:w-4/12 px-4 text-center">
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <p class="mt-2 mb-4 text-gray-600">
                                    Cơ sở vật chất tại DBEC được lắp đặt đầy đủ và thường xuyên được bảo trì, mang đến
                                    cho người dạy và người học cảm giác thoải mái và an toàn...
                                </p>
                    ...
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <p class="mt-2 mb-4 text-gray-600">
                                    DBEC là nơi đào tạo các lộ trình tiếng anh từ cơ bản đến nâng cao với giá thành hợp
                                    lí nhất...
                                </p>
                    ...
                    <div class="flex flex-wrap items-center">
                        ...
                        <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                            <div
                                ...
                                <img src="{{ asset('images/posts/' . $post11->picture) }}" alt="{{ $post11->picture }}"
                                ...
                                <blockquote class="relative p-8 mb-4">
                                    ...
                                    <p class="text-md font-light mt-2 text-white">
                                        Toàn diện trong đào tạo liên thông từ tiếng Anh trẻ em đến chuẩn đầu ra IELTS
                                        quốc tế
                                    </p>
                                </blockquote>
                            </div>
                        ...
                        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto mt-16">
                            <div
                                class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-pink-600">
                                <img src="{{ asset('images/posts/' . $post12->picture) }}" alt="{{ $post12->picture }}"
                                    class="w-full align-middle rounded-t-lg" />
                                <blockquote class="relative p-8 mb-4">
                                    <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 583 95" class="absolute left-0 w-full block"
                ...
                @else
                    <h2 class="text-4xl font-semibold text-center">Bài viết</h2>
                    <div class="text-center">Chưa có bài viết</div>
                @endif
            </div>
        </section>
                ...
                <div class="flex flex-wrap justify-center text-center mb-24">
                    <div class="w-full lg:w-6/12 px-4">
                        ...
                        <p class="text-lg leading-relaxed m-4 text-gray-600">
                            Giảng viên là lực lượng nồng cốt của DBEC, là người chỉ đường dẫn lối cho học viên đến với
                            thành công.
                        </p>
                    </div>
                </div>
                    ...
                    @foreach ($teachers as $t)
                        <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <a href="{{ route('teachers-details', $t->id) }}">
                                <div class="px-6">
                                    <img src="{{ asset('images/avatars/' . $t->avatar) }}" alt="{{ $t->avatar }}"
                                        class="transform transition-transform duration-400 hover:scale-125 shadow-lg rounded-full max-w-full mx-auto"
                                        style="max-width: 120px;" />
                                    <div class="pt-6 text-center">
                                        <h5 class="text-xl font-bold">
                                            @if ($t->gender == 'male')
                                                Mr. {{ $t->name }}
                                            @elseif($t->gender == 'female')
                                                Mrs. {{ $t->name }}
                                            @else
                                                {{ $t->name }}
                                            @endif
                                        ...
                                        <div class="mt-6">
                                            <button href="{{ route('teachers-details', $t->id) }}"
                                                class="bg-blue-400 hover:bg-blue-600 text-white rounded-xl outline-none focus:outline-none mr-1 mb-1 px-2 py-2"
                                                type="button">
                                                Show More
                                            </button>
                                        </div>
            ...
            <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
                <div class="flex flex-wrap text-center justify-center">
                    <div class="w-full lg:w-6/12 px-4">
                        ...
                        <h4 class = "text-xl text-white mt-4">This is the place to update the latest news from DBEC
                        </h4>
                    </div>
                </div>
                @if ($posts)
                            ...
                            @foreach ($posts as $post)
                                <div class="col-span-3 sm:col-span-1 mt-8">
                                    <a href="{{ route('posts-details', $post->id) }}">
                                        <div class="px-6">
                                            <img src="{{ asset('images/posts/' . $post->picture) }}"
                                                alt="{{ $post->picture }}"
                                                class="transform transition-transform duration-400 hover:scale-125 shadow-lg mx-auto max-h-72" />
                                            <div class="pt-6 text-center ">
                                                ...
                                                <p class="mt-1 text-sm uppercase font-semibold">
                                                    <a class="hover:text-red-500"
                                                        href="{{ route('posts-details', $post->id) }}">Xem thêm</a>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
                ...
                @else
                    <div class="text-center text-xl text-white">Chưa có bài viết</div>
                @endif
            </div>
        </section>
