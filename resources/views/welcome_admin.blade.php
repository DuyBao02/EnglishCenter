          ...
          <div class="items-center flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                <a
                  type="button"
                  class="transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 duration-300 w-1/2 px-18 py-2 mt-4 text-white bg-pink-500 rounded-lg hover:bg-pink-700"
