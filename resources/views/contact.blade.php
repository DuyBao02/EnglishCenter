                    ...
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            ...
                            <form action="{{ route('feedback') }}" method="POST">
                                ...
                                <textarea id="comment_content" name="comment_content" placeholder="Comment here..." rows="5" cols="80"
                                    required autofocus autocomplete="comment_content"></textarea><br />
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-16">
                        ...
                        <div class="wrapper max-w-full bg-gray-200 font-sans pt-5 shadow-md rounded-2xl">
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                <h2 class="text-black font-semibold text-xl">
                                    <i class="fas fa-clock"></i> 7:30 - 21:30
                                </h2></br>

                                <h2 class="text-black font-semibold text-xl">
                                    <i class="fas fa-envelope"></i>
                                    <a style="color: #000;text-decoration: none;" href="mailto:dbec@gmail.com">
                                        dbec@gmail.com</a>
                                </h2></br>
                                ...
                                <h2 class="text-black font-semibold text-xl">
                                    ...
                                    <a style="color: #000;text-decoration: none;"
                                        href="mailto:baob2016946@student.ctu.edu.vn"> baob2016946@student.ctu.edu.vn</a>
                                </h2></br>

                                <h2 class="text-black font-semibold text-xl">
                                    <i class="fas fa-mobile-alt"></i>
                                    <a style="color: #000;text-decoration: none;" href="tel:+84 932941222"> +84
                                        932941222</a>
                                </h2></br>

                                <h2 class="text-black font-semibold text-xl">
                                    <i class="fas fa-phone-alt"></i>
                                    <a style="color: #000;text-decoration: none;" href="tel:+84 123456789"> (0123) 4 567
                                        789</a>
                                </h2>
                            </div>
                        </div>
