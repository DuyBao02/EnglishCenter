<x-app-layout>
    ...
    <form action="" method="" class="flex items-center space-x-4 mx-4 lg:mx-0 lg:float-right lg:px-40 mt-4">
        <input autofocus type="search" name="search" id="" value="{{ $search }}" placeholder="Search by name, role, email, birthday, add, tel" class="border p-2 px-4 rounded-full w-96 focus:outline-none focus:shadow-outline-blue focus:border-blue-300">
